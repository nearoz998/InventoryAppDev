<div class="ibox">
    ...
    <div class="ibox-body">
        <form action="{{ route('productcategories.update', $category->id) }}" class="form-horizontal"
            id="productcategoryform-{{ $category->id }}" method="POST" enctype="multipart/form-data"
...
@include('cms.validations.formvalidation', ['id' => $category->id])
